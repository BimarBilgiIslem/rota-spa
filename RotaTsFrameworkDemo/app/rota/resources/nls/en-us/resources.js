define({
    ...
    rota: {
        ...
        fotodegistirhata: 'Avatar change failed !',
        yardim: 'Help',
        ...
        hizlimenusilmehatasi: 'This item can not be removed',
        ...
        zorunlualanlarvar: 'Type in missing fields !',
        evet: 'Yes',
        hayir: 'No',
        kopyalaniyor: 'Copying',
        disariyaaktar: 'Export',
        aktarallexcel: 'All data .xlsx',
        aktarekrandakiexcel: 'Visible data .xlsx',
        aktarseciliexcel: 'Selected data .xlsx',
